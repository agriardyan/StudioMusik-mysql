<%-- 
    Document   : halaman-suksesUpdate-member
    Created on : Dec 18, 2014, 10:01:51 PM
    Author     : root
--%>
    ...
    <body>
        ...
        <div class="ui one column page grid" id="formCek">
            <div class="column">
                <!--Search box-->
                <!--End of Search box-->
                <form class="ui fluid form segment" action="halamanutamamember" id="cekForm" >
                    <div class="fields">
                        <h2><font face="calibri"> Terima kasih </font></h2>
                        <h4><font face="calibri"> Data akun anda sudah diperbarui</font></h4>
                        <br>
                    </div>    
